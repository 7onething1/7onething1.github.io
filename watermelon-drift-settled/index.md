...
**Settled by eye, in a second representation.** Spectrograms of single bars, all on one dB scale, with a genuinely silent stretch as control: bar 17 shows 12-14 broadband striations matching its 20-note control bar 16; coda bars 99 and 100 show 10-12 discrete striations, dimmer and clearly present; bar 105 is near black and the post-song reference is completely black. **The silent control is what makes the coda readable.** Nothing rests on the onset detector; the arbiter both times was the eye, and the first pass simply read a shared-axis overview.
