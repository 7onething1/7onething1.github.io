...
Ranking = a composite of five reads (Out-of-box Power, Upgrade Ceiling, Fun, Ease to pilot, Table Politics), each 1–10. Scores are editorial opinion grounded in the printed cards and the upgrade guides, not tournament data. Re-sort by any single metric on the page.

**Exact formula (now shown on the page):** Overall = 0.28 · Out-of-box power + 0.26 · Upgrade ceiling + 0.24 · Fun + 0.12 · Ease + 0.10 · Table politics. **Fun** = variety, dramatic swing, and live decisions per game, not win rate. **Table politics** = how the pod treats the deck (how fast it draws targeting, how much it can threaten, deal, or share). Fun carries nearly the weight of power on purpose: these are precons for casual, kitchen-table play, where how much a deck is worth playing counts almost as much as how hard it hits.

## The ranking

### 1. Doom Prevails · Grixis (U/B/R)
Discard-matters villains with two engines. **Doctor Doom, King of Latveria** drains the table when you discard lands and connives your villains; **Loki, the Deceiver** copies your best villain into a swarm of attackers. Loki's copy-and-swing line is the strongest single play in the set.
...
### 2. The Fantastic Four · Four-color (U/R/G/W)
Highest ceiling in the set and the only four-color deck. Pick your favorite of Marvel's First Family; every face rewards casting a noncreature spell each turn. Upgrades into a real spellslinger machine; four-color mana is the cost.
...
### 3. Avengers Assemble · Jeskai (R/W/U)
The clean, beginner-friendly starter. **Captain America, Team Leader** hands haste and +1/+1 counters to every Hero that lands; **Director Nick Fury** keeps the team coming. Straightforward, lowest ceiling of the top three.
...
- **Best build-around:** Captain America, Team Leader.
...
### 4. Wakanda Forever · Selesnya (G/W)
Most focused, weakest out of the box. **T'Challa, the Black Panther** spins up indestructible Vibranium artifact tokens and grows on big artifact spells; **Shuri** turns an artifact count into lifelink beats. Leans on filler that upgrades want gone.
...
- **Play it as-is, no upgrades:** Doom Prevails, tied with the Fantastic Four for the highest out-of-box power (7.5), taking the pick as #1 overall and the more forgiving of the two.
- **Best long-term project:** The Fantastic Four, the biggest climb, 7.5 out of the box to an 8.6 ceiling.
...
Doom is the most-adopted lead; the count is not what sets the composite ranking. The upgrade guides (Draftsim, Gathering Games, Command Zone) are the source for the swaps, not for this four-deck ordering, which is the page's own read.
