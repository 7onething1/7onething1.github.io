# 7.3.26 Jam Rebuild: Song 10 (drum-split stems)

Seven-lane web mixer for song 10 of the 7.3.26 jam rebuild. Every stem is decoded once onto a
...
Drums present (drum RMS about -30 dB) and continuous (100% active, zero internal starts/stops).
Cuts that failed either rule were not built.

## Ableton import (raw WAVs)
Lossless WAVs: `/Volumes/T7 Shield/jam-7-3-26-rebuild/packages/song10/` with `ABLETON_IMPORT.md`.
